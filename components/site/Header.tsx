...
export function Header() {
  ...
  return (
    ...
    <header className="fixed inset-x-0 top-0 z-40">
      ...
      <div className="mx-auto max-w-7xl rounded-b-[3.5rem] border border-t-0 border-line bg-white shadow-xl shadow-navy-950/15">
        ...
        {/* Mobil menü */}
        {open && (
          <nav className="rounded-b-[3.5rem] border-t border-line bg-white px-6 pb-5 lg:hidden">
            {navItems.map((item) => (
              <div key={item.href}>
                <Link
                  href={item.href}
